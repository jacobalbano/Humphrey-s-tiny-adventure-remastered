package
{
	...
	*/
	public class EmbeddedAssets
	{
		...
		[Embed(source = "../lib/scripts/desert/director.xml", mimeType = "application/octet-stream")] private const FLAKIT_ASSET$_979389132:Class;
		...
		public function EmbeddedAssets()
		{
			...
			Library.addXML(new String("scripts/desert/director.xml").split("/").join("."), getXML(FLAKIT_ASSET$_979389132));
